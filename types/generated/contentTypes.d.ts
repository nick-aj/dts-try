...
export interface ApiCensusCensus extends Schema.SingleType {
...
export interface ApiStaffStaff extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Role: Attribute.Enumeration<['Chef', 'Waiting Staff', 'Cashier']> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTestingTesting extends Schema.SingleType {
  ...
  attributes: {
    Something: Attribute.Date;
    Smthng: Attribute.Email;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::census.census': ApiCensusCensus;
